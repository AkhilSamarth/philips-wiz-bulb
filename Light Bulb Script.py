...
def setColor(r, g, b, w=0, c=0):
    ...
    payload='{"method":"setPilot","env":"pro","params":{"mac":"' + bulb_mac + '","rssi":-73,"src":"","state":true,"dimming":100,'
...
def setTemp(temp, brightness=100):
    ...
    payload='{"method":"setPilot","env":"pro","params":{"mac":"' + bulb_mac + '","rssi":-73,"src":"","state":true,'
...
def changeState(state=None):
    ...
    payload='{"method":"setPilot","env":"pro","params":{"mac":"' + bulb_mac + '","rssi":-73,"src":"",'
